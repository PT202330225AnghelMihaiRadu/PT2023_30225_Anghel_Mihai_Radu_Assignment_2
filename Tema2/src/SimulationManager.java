...
public class SimulationManager implements Runnable {
    ...
    public void run() {
        ...
        double avgWaitingTime = (double) totalWaitingTime / totalNumberOfClients;
        double avgServiceTime = (double) totalServiceTime / totalNumberOfClients;


        System.out.println("Average waiting time: " + avgWaitingTime);
        //this.frame.setAvgWaitingTime(avgWaitingTime);
        System.out.println("Average service time: " + avgServiceTime);
        //this.frame.setAvgServiceTime(avgServiceTime);
        System.out.println("Peak hour: " + peakHour);
        //this.frame.setPeakHour(peakHour);
    }
